  ...
  return (
    <>
      ...
      <section className="mx-auto flex max-w-4xl flex-col items-center gap-8 px-6 pb-16 pt-4 md:flex-row md:items-center md:justify-center md:gap-10 md:px-8 md:pb-20 md:pt-8">
        <div className="relative flex flex-col items-center text-center md:-translate-x-8 md:items-end md:text-right lg:-translate-x-12">
          <div
          ...
          <p className="oracle-subtitle max-w-md">
